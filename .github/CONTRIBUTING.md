...
Contributions to FarmPi are highly encouraged and desired. Below are some guidelines that will help make the process as smooth as possible.
...
We want to know what you think is missing from FarmPi and how it can be made better.
...
* To quickly create a topic branch based on master; `git checkout -b my_contribution master`. Please avoid working directly on the `main` branch.
...
* Make sure your commit messages are in the proper format.
  ...
  The functionally of Get-Something would be greatly improved if there was a little
